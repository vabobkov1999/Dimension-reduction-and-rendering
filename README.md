...
In this work, using python and PCA and TNCE methods, visualize the features obtained in previous works (links to them are indicated below).
...
Замечание:
-----------
Для лабораторной работы [№3](https://github.com/vabobkov1999/Image-Training) методы PCA и t-NSE работают ужасно. Это происходит из-за того, что некачественно были выбраны фитчи.
...
#### Как должен выглядеть график методов PCA или t-NSE:
